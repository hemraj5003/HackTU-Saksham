        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-6">
            ...
            <p className="text-gray-400 leading-relaxed">
              At Saksham, we are committed to transforming cybersecurity through innovative AI technologies. 
              Our mission is to empower individuals and organizations with intelligent, proactive security solutions 
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 leading-relaxed">
              We envision a world where cybersecurity is proactive, intelligent, and accessible. 
              By leveraging cutting-edge AI and machine learning, we aim to create security solutions 
              that are one step ahead of emerging digital threats.
            </p>
          </div>
        </div>
